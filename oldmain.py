...
mqtt_client_id = "picow-test"
mqtt_server = "192.168.15.3"
mqtt_port = 1883
mqtt_user = b"iot-devices"
mqtt_password = b"MGZ4CXNizJLuxws"
...
while True:
    ...
    ## If it has been 20 seconds since the door started moving, we can assume that is has stopped and reached its final position ##
